...
var colors = { "": "white", "2":"gray", "4":"#ecefc8", "8":"#f2b179", "16":"#f59563", "32":"#f57c5f", "64":"#f95c3b",
...
function check2048()
{
    for (var i = 0; i < arrCells.length; ++i) {
        for (var j = 0; j < arrCells[i].length; ++j) {
            if (arrCells[i][j] !== 0 && arrCells[i][j] === 2048) {
                return true;
            }
        }
    }
...
function create(row, col, value, respaun)
{
    ...
    console.log("object location "+object.x+" : "+object.y)
}
